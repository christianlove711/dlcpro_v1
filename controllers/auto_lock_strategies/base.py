...
from controllers.auto_lock_acquisition import AcquisitionFrame
...
class AutoLockStrategyBase:
    key = "base"
    text_key = "auto_lock_strategy_hybrid"
    control_label = "signal"

    def analyze(self, frame: AcquisitionFrame, settings: AutoLockSettings) -> SignalAnalysis:
    ...
    def search_exhausted_message(self) -> str:
        return f"{self.control_label} search exhausted; AutoLock stopped"
...
def analyze_signals(frame: AcquisitionFrame, settings: AutoLockSettings) -> SignalAnalysis:
