...
module tb_pl_raw_udp_streamer;
  ...
  reg [63:0] sample_index=0, next_sample_index=0;
  ...
  initial begin
    #2_000_000;
    $display("DEBUG timeout busy=%b fifo=%0d ready=%b stage=%0d monitor=%b rd_busy=%b requested=%0d stream_sync=%0d active_stream=%0d",
             dut.busy,monitor_fifo_level,dut.packet_ready,dut.stage_count,dut.monitor_sync[1],
