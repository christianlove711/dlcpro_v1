...
class AutoLockConfigPanel(QFrame):
    def __init__(self) -> None:
        ...
        self.preset_selected_label = QLabel()
        self.preset_selected_value = QLabel()
        self.preset_selected_value.setObjectName("ReadValue")
        preset_form.addRow(self.preset_selected_label, self.preset_selected_value)
        ...
        self.preset_scope_button = QPushButton()
        ...
        self.preset_button_row.addWidget(self.preset_scope_button)
        self.preset_button_row.addWidget(self.preset_new_button)
        self.preset_button_row.addWidget(self.preset_load_button)
