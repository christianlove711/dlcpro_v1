...
class CcPanel(QFrame):
    ...
    def __init__(self, owner) -> None:
        ...
        self.cc_enable_button = create_toggle_button(owner._on_cc_enable_toggled)
        ...
        self.feedforward_enable_button = create_toggle_button(owner._on_feedforward_enable_toggled)
        ...
        self.arc_enable_button = create_toggle_button(owner._on_arc_enable_toggled)
