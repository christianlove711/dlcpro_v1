...
class PcPanel(QFrame):
    ...
    def __init__(self, owner) -> None:
        ...
        header.addStretch(1)
        self.pc_enable_button = create_toggle_button(owner.laser_controller._on_pc_enable_toggled)
        ...
        self.pc_voltage_set_spin.connect_live_apply(owner.laser_controller._on_pc_voltage_set_finished)
        ...
        self.pc_slew_rate_enable_button = create_toggle_button(owner.laser_controller._on_pc_slew_rate_enable_toggled)
        ...
        self.pc_slew_rate_spin.connect_live_apply(owner.laser_controller._on_pc_slew_rate_finished)
        ...
        self.pc_arc_enable_button = create_toggle_button(owner.laser_controller._on_pc_arc_enable_toggled)
        ...
        self.pc_arc_signal_combo.currentIndexChanged.connect(owner.laser_controller._on_pc_arc_signal_changed)
        ...
        self.pc_arc_factor_spin.connect_live_apply(owner.laser_controller._on_pc_arc_factor_finished)
        ...
        self.pressure_comp_enable_button = create_toggle_button(owner.laser_controller._on_pressure_comp_enable_toggled)
        ...
        self.pressure_comp_factor_spin.connect_live_apply(owner.laser_controller._on_pressure_comp_factor_finished)
